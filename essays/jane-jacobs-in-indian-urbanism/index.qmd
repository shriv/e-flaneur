...
Over the last few decades urban sprawl has resulted in large scale losses of green space in the global south. In Mumbai, dense vegetation has reduced by 50% lost in the recent three decades from 1988 - 2018 [@rahamanSpatiotemporalChangesGreen2021]. Sprawl is also directly connected to the wellbeing of citizens and their exposure to the increasing consequences of climate change. Unchecked expansion of grey infrastructure without appropriate tree cover and green spaces results in poor resilience to extreme weather events - from urban heat islands that magnify temperatures well above thermal comfort [@vinayakImpactsFutureUrbanization2022] and widespread flooding [@paulIncreasedSpatialVariability2018] during intense storm or monsoon downpours. 
...
In recent years, a flurry of regulation changes have increased the allowed FSI in urban areas. However, meaningfully improved urban development requires active engagement from urban planners. In his recent step-by-step analysis of urban intervention in the large Indian city of Ahmedabad,  Dr. Bimal Patel [@puneinternationalcentreSessionManagingUrban2023] emphasises the importance of actions that increase public infrastructure alongside the FSI. 

Indian cities usually lack good street network connectivity [@barrington-leighGlobalTrendsUrban2020] [@jameelaahmedRoadTestNine2020] to cope with the expected increase in population and traffic volumes brought about by the FSI changes. Addressing this deficit needs more active management than just changing a number in the building code. Dr. Patel recommends additional actions for planners along with increasing FSI:

- **buying un-utilised private land**, currently languishing as private and un-used open space in many Indian cities [@AlainBertaudBimal] due to building regulations that ossified urban form to low efficiency layouts. This land can be used to add streets that improve street network connectivity or increase existing capacity. 
...
Without an explicit connection, this plan exemplifies the four generators of urban vitality à la Jane  Jacobs [@jacobsDeathLifeGreat1992] [@JaneJacobsGenerators]. 

-  **Density**. Increasing the FSI incentivises developers to make the most of the land and enables higher density. They can build up as well as out within the plot - especially if money was made by selling land to the municipality for new streets resulted in a smaller plot to work with for the actual building.
- **Mingled buildings**. Incremental additions of newer, taller buildings (depending on the pace of development) amidst the older ones without specifically stipulating that outcome. 
-  **Short blocks**. Adding new streets that break up a large block resulting in the shorter blocks of Jacobsian preference though the Dr. Patel favours side streets for vehicular ins and outs.  
