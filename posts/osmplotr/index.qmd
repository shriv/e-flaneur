...
- Using `osmplotr` [@RopensciOsmplotr2022] to pull specific spatial elements like parks, building networks and street works and print a visually consistent map. The handy `make_osm_map()` function both gets the data and prints the map according to the set colour scheme for the different elements. 
