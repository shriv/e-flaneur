...
The [previous post](https://shriv.github.io/e-flaneur/posts/bldg-heights-footprints/), noted the value of retrieving a summarised height data for a building polygon from the overlaid raster cells. In this post, I look at how the package `exactextractr` [@exactextractr], typically used in the calculation of `zonal statistics`, can make my use case a fast and easy task. 
